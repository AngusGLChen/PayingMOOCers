...
def ExerciseCheckerSorted(path):
    ...
    # Gather the solution
    solution_path = path + "Solutions/Week5.xlsx"
    ...
    output_path = path + "Checking_results/week5_results"
    if os.path.isfile(output_path):
        os.remove(output_path)
    output = open(output_path, "w")    
    
    # Gather the response
    answer_path = path + "Response/Week_5/"
        ...
        try:
            ...
            for i in range(len(solution_columns)):
                ...
                if i in [0, 1]:
                    ...
                    # To change answer_columns
                    updated_answer_columns = []
                    for answer_column in answer_columns:
                        ...
                        updated_answer_columns.append(answer_column_array)
                    
                    
                    check_result = True
                    num_solution_element = len(solution_columns[i])
                
                    solution_column = []
                    for element in solution_columns[i]:
                    ...
                    for answer_column_array in updated_answer_columns:                
                    ...
                    for answer_column in answer_columns:
                        ...
                        for solution_element in solution_columns[i]:
...
def ExerciseCheckerUnsorted(path):
    ...
    # Output the checking result
    output_path = path + "Checking_results/week5_results_unsorted"
    if os.path.isfile(output_path):
        os.remove(output_path)
    output = open(output_path, "w")    
